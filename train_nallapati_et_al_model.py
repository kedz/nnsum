...
from model_util import summarunner_extractor_model 
...
def main():
    ...
    # Document Decoder Parameters
    parser.add_argument(
        "--dec-sent-size", default=300, type=int)
    parser.add_argument(
        "--dec-doc-size", default=400, type=int)
    parser.add_argument(
        "--dec-num-positions", default=50, type=int)
    parser.add_argument(
        "--dec-num-segments", default=4, type=int)
    parser.add_argument(
        "--dec-position-size", default=50, type=int)
    parser.add_argument(
        "--dec-segment-size", default=50, type=int)
...
#    parser.add_argument("--attention", default=None, choices=["dot"])
    ...
    model = summarunner_extractor_model(
        embeddings,
        ...
        dec_sent_size=args.dec_sent_size,
        dec_doc_size=args.dec_doc_size,
        dec_num_segments=args.dec_num_segments,
        dec_num_positions=args.dec_num_positions,
        dec_segment_size=args.dec_segment_size,
        dec_position_size=args.dec_position_size)
