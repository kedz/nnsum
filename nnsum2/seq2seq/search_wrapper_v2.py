...
from nnsum2.seq2seq.searches import GreedySearch, BeamSearch


@Parameterized.register_object("seq2seq.search_wrapper2")
class SearchWrapper2(Parameterized):
    ...
    def _beam_decode(self, model, inputs, encoded_inputs=None):
        ...
        return BeamSearch(model.decoder, {"encoder_state": encoder_state}, 
                          context, 
    ...
    def _greedy_decode(self, model, inputs, encoded_inputs=None):
        ...
        context, encoder_state = encoded_inputs
        return GreedySearch(model.decoder, {"encoder_state": encoder_state}, 
                            context, 
                            max_steps=self.max_steps,
                            return_incomplete=self.return_incomplete)
